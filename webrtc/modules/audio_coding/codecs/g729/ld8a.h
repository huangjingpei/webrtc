...
typedef struct
{
    ...
    Word16 mem_syn_pst[M];    /* memory of filter 1/A(z/GAMMA1_PST) */
...
typedef struct
{
    Word16  bad_lsf;
    Word16  frame_num;
    Word16  synth_buf[L_FRAME+M];         /* Synthesis                   */
...
void Init_Post_Process(PopStatus *handle);
...
int  prm2bits_ld8k(Word16 prm[], Word16 bits[]);
...
void   update_exc_err(Word32 *L_exc_err, Word16 gain_pit, Word16 t0);
Word16 test_err(Word32 *L_exc_err, Word16 t0, Word16 t0_frac);
